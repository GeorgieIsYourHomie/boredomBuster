...
const App = () => {
    ...
    // * - RENDERING -
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "max-w-100 mx-auto my-6 p-8 flex w-full flex-col justify-center px-6 md:max-w-4xl" }, { children: [(0, jsx_runtime_1.jsxs)("header", { children: [(0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(NavBar_1.default, {}) }), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: "w-100 my-2.5" }, { children: (0, jsx_runtime_1.jsx)("img", { className: "floating max-w-6xl", src: "images/boredom-buster-logo.svg", alt: "Logo design of Boredom Buster app, sans-serif font with outlined symbol of explosion." }) }))] }), (0, jsx_runtime_1.jsx)("main", Object.assign({ className: "mt-9 flex w-full flex-col justify-center text-center" }, { children: (0, jsx_runtime_1.jsx)(FindActivity_1.default, { selectedCategories: selectedCategories, chosenCategories: chosenCategories, toggleCategory: toggleCategory }) }))] })));
}; // * - END App COMPONENT -
